...
namespace ArtistandSongApponetomany.Controllers
{
    public class SongsController : Controller
    {
        ...
        {
            var applicationDbContext = _context.Songs.Where(song => song.ArtistId == id);
            return View(await applicationDbContext.ToListAsync());
        }
        // GET: Songs/Details/5
        ...
        public async Task<IActionResult> Create([Bind("SongId,Title,SongType,Description,ArtistId")] Song song)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("SongId,Title,SongType,Description,ArtistId")] Song song)
        {
            if (id != song.SongId)
            {
                return NotFound();

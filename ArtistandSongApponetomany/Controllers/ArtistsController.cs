...
namespace ArtistandSongApponetomany.Controllers
{
    public class ArtistsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ArtistId,FirstName,LastName,Email")] Artist artist)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ArtistId,FirstName,LastName,Email")] Artist artist)
        {
